...
function encryptedString(n, t) {
    ...
    for (var l = [], p = t.length, i = 0; i < p;) l[i] = t.charCodeAt(i),
    i++;
    for (e = l.length, o = "", i = 0; i < e; i += n.chunkSize) {
        for (c = new BigInt, s = 0, f = i + n.chunkSize > e ? e % n.chunkSize: n.chunkSize, u = [], r = 0; r < f; r++) u[r] = l[i + f - 1 - r];
        for (u[f] = 0, v = Math.max(8, n.digitSize - 3 - f), r = 0; r < v; r++) u[f + 1 + r] = Math.floor(Math.random() * 254) + 1;
        for (u[n.digitSize - 2] = 2, u[n.digitSize - 1] = 0, h = 0; h < n.digitSize; ++s) c.digits[s] = u[h++],
        c.digits[s] += u[h++] << 8;
        a = n.barrett.powMod(c, n.e);
        y = n.radix == 16 ? biToHex(a) : biToString(a, n.radix);
        o += y + " "
    }
    return o.substring(0, o.length - 1)
}
function decryptedString(n, t) {
    for (var e = t.split(" "), i = "", u, f, o, r = 0; r < e.length; ++r) for (o = n.radix == 16 ? biFromHex(e[r]) : biFromString(e[r], n.radix), f = n.barrett.powMod(o, n.d), u = 0; u <= biHighIndex(f); ++u) i += String.fromCharCode(f.digits[u] & 255, f.digits[u] >> 8);
...
function getEncryptPwd(n, t) {
    if (!rsakey) {
        ...
        setMaxDigits(129);
        rsakey = new RSAKeyPair(r, "", i)
    }
    return encryptedString(rsakey, n)
}
var biRadixBase = 2,
biRadixBits = 16,
...
maxDigits, ZERO_ARRAY, bigZero, bigOne, dpl10, lr10, hexatrigesimalToChar, hexToChar, highBitMasks, lowBitMasks, rsakey;
setMaxDigits(20);
dpl10 = 15;
