...
function(n) {
    ...
    function t() {
        ...
        for (var t in n) if (i.style[t] !== undefined) return {
            end: n[t]
        };
        return ! 1
    }
    ...
    n(function() { (n.support.transition = t(), n.support.transition) && (n.event.special.bsTransitionEnd = {
...
function(n) {
    ...
    t.prototype.close = function(i) {
        ...
        r; (u || (u = f.attr("href"), u = u && u.replace(/.*(?=#[^\s]*$)/, "")), r = n(u === "#" ? [] : u), i && i.preventDefault(), r.length || (r = f.closest(".alert")), r.trigger(i = n.Event("close.bs.alert")), i.isDefaultPrevented()) || (r.removeClass("in"), n.support.transition && r.hasClass("fade") ? r.one("bsTransitionEnd", e).emulateTransitionEnd(t.TRANSITION_DURATION) : e())
    };
    r = n.fn.alert;
    n.fn.alert = u;
...
function(n) {
    ...
    function i(i) {
        return this.each(function() {
            ...
            f = n.extend({},
            t.DEFAULTS, u.data(), typeof i == "object" && i),
...
function(n) {
    ...
    function i(i) {
        return this.each(function() {
            ...
            f = n.extend({},
            t.DEFAULTS, u.data(), typeof i == "object" && i); ! r && f.toggle && /show|hide/.test(i) && (f.toggle = !1);
...
function(n) {
    ...
    t.prototype.keydown = function(t) {
        ...
        if (/(38|40|27|32)/.test(t.which) && !/input|textarea/i.test(t.target.tagName) && (e = n(this), t.preventDefault(), t.stopPropagation(), !e.is(".disabled, :disabled"))) {
            if (o = r(e), s = o.hasClass("open"), !s && t.which != 27 || s && t.which == 27) return t.which == 27 && o.find(i).trigger("focus"),
            e.trigger("click"); (h = " li:not(.disabled):visible a", f = o.find(".dropdown-menu" + h), f.length) && (u = f.index(t.target), t.which == 38 && u > 0 && u--, t.which == 40 && u < f.length - 1 && u++, ~u || (u = 0), f.eq(u).trigger("focus"))
        }
    };
    f = n.fn.dropdown;
    n.fn.dropdown = o;
...
function(n) {
    ...
    function i(i, r) {
        return this.each(function() {
            ...
            u = f.data("bs.modal"),
            e = n.extend({},
            t.DEFAULTS, f.data(), typeof i == "object" && i);
    ...
    function(t) {
        ...
        u.one("show.bs.modal",
        function(n) {
            if (!n.isDefaultPrevented()) u.one("hidden.bs.modal",
            function() {
...
function(n) {
    ...
    function r(i) {
        return this.each(function() {
            var u = n(this),
            r = u.data("bs.tooltip"),
            f = typeof i == "object" && i; (r || !/destroy|hide/.test(i)) && (r || u.data("bs.tooltip", r = new t(this, f)), typeof i == "string" && r[i]())
        })
    }
    var t = function(n, t) {
        this.type = null;
    ...
    t.prototype.init = function(t, i, r) {
        ...
        for (f = this.options.trigger.split(" "), e = f.length; e--;) if (u = f[e], u == "click") this.$element.on("click." + this.type, this.options.selector, n.proxy(this.toggle, this));
        else if (u != "manual") {
    ...
    t.prototype.hide = function(i) {
        ...
        if (this.$element.trigger(f), !f.isDefaultPrevented()) return u.removeClass("in"),
        n.support.transition && u.hasClass("fade") ? u.one("bsTransitionEnd", e).emulateTransitionEnd(t.TRANSITION_DURATION) : e(),
        this.hoverState = null,
        this
    };
    t.prototype.fixTitle = function() {
        var n = this.$element; (n.attr("title") || typeof n.attr("data-original-title") != "string") && n.attr("data-original-title", n.attr("title") || "").attr("title", "")
    };
...
function(n) {
    ...
    function r(i) {
        return this.each(function() {
            var u = n(this),
            r = u.data("bs.popover"),
            f = typeof i == "object" && i; (r || !/destroy|hide/.test(i)) && (r || u.data("bs.popover", r = new t(this, f)), typeof i == "string" && r[i]())
        })
    }
    var t = function(n, t) {
...
function(n, t) {
    ...
    n.fn.dropdownHover = function(r) {
        ...
        this.each(function() {
            ...
            o;
            u.hover(function(n) {
                if (!u.hasClass("open") && !e.is(n.target)) return ! 0;
                f.instantlyCloseOthers === !0 && i.removeClass("open");
                t.clearTimeout(o);
                u.addClass("open")
            },
            function() {
